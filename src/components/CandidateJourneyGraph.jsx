...
const CandidateJourneyGraph = ({ theme }) => {
  ...
  const candidates = [
    {
      id: 1,
      color: 'var(--color-candidate-1)',
      label: 'Candidate 1',
      path: 'M 50 20 L 150 25 L 250 95 L 350 70 L 450 95',
    },
    {
      id: 2,
      color: 'var(--color-candidate-2)',
      label: 'Candidate 2',
      path: 'M 50 10 L 150 30 L 250 35 L 350 5 L 450 5',
    },
    {
      id: 3,
      color: 'var(--color-candidate-3)',
      label: 'Candidate 3',
      path: 'M 50 25 L 150 15 L 250 80 L 350 85 L 450 55',
    },
    {
      id: 4,
      color: 'var(--color-candidate-4)',
      label: 'Candidate 4',
      path: 'M 50 18 L 150 8 L 250 75 L 350 40 L 450 35',
    },
    {
      id: 5,
      color: 'var(--color-candidate-5)',
      label: 'Candidate 5',
      path: 'M 50 5 L 150 5 L 250 20 L 350 70 L 450 80',
    },
    {
      id: 6,
      color: 'var(--color-candidate-6)',
      label: 'Candidate 6',
      path: 'M 50 5 L 150 5 L 250 22 L 350 90 L 450 75',
    },
  ];
  ...
  const annotations = [
    ...
    {
      text: 'Opportunity for intervention',
      x: 250,
      y: 108,
      rotation: 0,
      delay: 1.6,
